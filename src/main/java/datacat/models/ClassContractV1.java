...
public class ClassContractV1 {
    ...
    // "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'") // uncomment after update
    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
    ...
    // return childClassReferences != null ? childClassReferences : new
    // ArrayList<>();
    // }
    ...
    // return reverseClassRelations != null ? reverseClassRelations : new
    // ArrayList<>();
    // }
