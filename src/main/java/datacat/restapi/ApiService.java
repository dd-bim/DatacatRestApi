...
public class ApiService {
    ...
    // rootField should match the field in the response (e.g. "getSubject",
    // "getBag", "findSubjects", "findProperties", etc.)
    // =====================================================================================================================
    // SECTION: CLASS
    // =====================================================================================================================
    ...
    // List<UnitContractV1> units = deserializeInnerFindResponse(response,
    // rootField, UnitContractV1.class);
